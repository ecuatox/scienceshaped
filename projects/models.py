...
class Illustration(models.Model):
    ...
    image1 = models.CharField(max_length=200, blank=True, verbose_name='Image')
    image2 = models.CharField(max_length=200, blank=True, verbose_name='Image')
    image3 = models.CharField(max_length=200, blank=True, verbose_name='Image')
